...
export const Checkout: React.FC = () => {
  ...
  if (!cartData || itemsCount === 0) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-16 text-center">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight mb-4">Your Cart is Empty</h2>
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-950 min-h-screen py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-5 mb-8">
          <div>
            <Link to="/cart" className="inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 dark:text-gray-300 mb-2">
          ...
          <div className="mt-4 md:mt-0 flex items-center gap-2 text-sm text-gray-500 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-lg p-2.5 shadow-xs">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xs border border-gray-100 dark:border-gray-800 p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                  <div className="h-8 w-8 rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 flex items-center justify-center font-bold text-sm">
                    1
                  </div>
                  <h2 className="text-xl font-bold text-gray-950 dark:text-white">Shipping Address</h2>
                </div>
                {!isAddingAddress && (
                  <button
              ...
              <AnimatePresence mode="wait">
                {isAddingAddress ? (
                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-xs focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500"
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-xs focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 bg-white dark:bg-gray-900"
                      >
                    ...
                    <div className="flex gap-3 justify-end pt-2">
                      <button
                        ...
                        className="px-4 py-2 border border-gray-300 hover:bg-gray-50 dark:bg-gray-950 text-gray-700 dark:text-gray-300 font-medium rounded-lg text-sm transition-colors"
                      >
                        Cancel
                      </button>
                      <button
                  ...
                  >
                    {addresses.length === 0 ? (
                      <div className="text-center py-8 border-2 border-dashed border-gray-250 rounded-xl bg-gray-50 dark:bg-gray-950">
                        <MapPin className="mx-auto h-12 w-12 text-gray-400 mb-3" />
                        <p className="text-gray-600 dark:text-gray-400 font-medium mb-1">No saved addresses found</p>
                        <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">Set up a shipping address to estimate totals and check out.</p>
                        <button
                          onClick={() => setIsAddingAddress(true)}
                          ...
                          return (
                            <button
                              ...
                              className={`text-left p-4 rounded-xl border relative transition-all ${
                                isSelected
                                  ? 'border-indigo-600 ring-2 ring-indigo-500/10 bg-indigo-50 dark:bg-indigo-900/30/20'
                                  : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50 dark:bg-gray-950'
                              }`}
                            >
                              <div className="flex items-start justify-between mr-6">
                                <div>
                                  <p className="font-bold text-gray-900 dark:text-white">{addr.fullName}</p>
                                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">{addr.phone}</p>
                                </div>
                                {isSelected && (
                              ...
                              {addr.isDefault && (
                                <span className="absolute bottom-3 right-3 text-[10px] font-bold tracking-wider uppercase px-2 py-0.5 bg-gray-100 text-gray-600 dark:text-gray-400 rounded">
                                  Default
                                </span>
                              )}
                            </button>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xs border border-gray-100 dark:border-gray-800 p-6 space-y-5">
              <div className="flex items-center gap-2">
                <div className="h-8 w-8 rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 flex items-center justify-center font-bold text-sm">
                  2
                </div>
                <h2 className="text-xl font-bold text-gray-950 dark:text-white">Payment & Wallet Options</h2>
              </div>

              {/* Store Credit application toggle */}
              <div className="p-4 border border-gray-200 rounded-xl bg-gray-50 dark:bg-gray-950 flex items-start gap-3">
                <input
                  id="checkout-store-credit"
                  type="checkbox"
                  checked={useStoreCredit}
                  onChange={(e) => setUseStoreCredit(e.target.checked)}
                  className="h-4 w-4 mt-1 text-indigo-600 rounded border-gray-300 dark:border-gray-600"
                />
                <div className="text-left">
                  <label htmlFor="checkout-store-credit" className="font-bold text-gray-900 dark:text-white cursor-pointer">
              ...
              <div className="p-4 border border-gray-200 rounded-xl bg-white dark:bg-gray-900 space-y-3">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-grow text-xs border border-gray-300 rounded-lg px-3 py-2 font-mono uppercase tracking-wider focus:outline-none focus:border-indigo-600 text-gray-900 dark:text-white"
                  />
                  <button
                    type="button"
                    onClick={() => {
              ...
              <div className="p-4 border border-gray-200 rounded-xl bg-white dark:bg-gray-900 space-y-3">
                ...
                <form onSubmit={handleApplyGiftCard} className="flex gap-2">
                  <input
                    ...
                    className="flex-grow text-xs border border-gray-300 rounded-lg px-3 py-2 font-mono uppercase tracking-wider focus:outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600 text-gray-900 dark:text-white"
                  />
                  <button
                    type="submit"
                ...
                {appliedGiftCardCodes.length > 0 && (
                  <div className="space-y-1.5 pt-2 border-t border-dashed border-gray-150 text-left">
                    <p className="text-xs font-semibold text-gray-700 dark:text-gray-300">Applied Cards:</p>
                    {appliedGiftCardCodes.map((code) => (
                      <div key={code} className="flex justify-between items-center bg-gray-50 dark:bg-gray-950 px-2.5 py-1 rounded text-xs border border-gray-100 dark:border-gray-800">
              ...
              <div className="p-4 border border-gray-200 rounded-xl bg-gray-50 dark:bg-gray-950 flex items-start gap-3">
                ...
                <div className="text-left">
                  <p className="font-semibold text-gray-950 dark:text-white">Primary Credit Card Gateway / COD</p>
          ...
          <div className="lg:col-span-5">
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xs border border-gray-100 dark:border-gray-800 p-6 sticky top-6 space-y-6">
              <h2 className="text-xl font-bold text-gray-950 dark:text-white">Order Summary</h2>
                ...
                {cartData.items.map((item: any) => {
                  ...
                  return (
                    <div key={item.id} className="py-3 flex items-center gap-3">
                      <div className="h-12 w-12 rounded bg-gray-100 flex-shrink-0 flex items-center justify-center overflow-hidden border border-gray-200 dark:border-gray-700">
                        {image ? (
